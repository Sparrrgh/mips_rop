...
from binaryninjaui import (getMonospaceFont, UIAction,
                           UIActionHandler, Menu, UIContext)
...
from PySide6.QtCore import (
    QDir, Qt, QFileInfo, QItemSelectionModel, QSettings, QUrl)
from PySide6.QtGui import (
    QFontMetrics, QDesktopServices, QKeySequence, QIcon, QColor, QAction)
...
if __name__ == "__main__":
    ...
    UIActionHandler.globalActions().bindAction(
        "mips_rop\\Settings", UIAction(openSettings))
    Menu.mainMenu("Plugins").addAction(
        "mips_rop\\Find ROP Gadgets", "mips_rop")
